 ...
 * 测试相机View
 */
public class TestCameraView extends SurfaceView implements Camera.AutoFocusCallback {

    private final static String TAG = "TestCameraView";
...
//                break;
//        }
        camera.setDisplayOrientation(TestCameraActivity.PREVIEW_DEGREE);
    }
